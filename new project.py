...
def sacar(*, saldo: float, valor: float, extrato: str, limite: float, numero_saques: int, limite_saques: int) -> tuple:
    ...
    # Retornando numero_saques atualizado para a main
...
def filtrar_usuario(cpf: str, usuarios: list) -> dict | None:
    usuarios_filtrados = [usuario for usuario in usuarios if usuario["cpf"] == cpf]
    return usuarios_filtrados[0] if usuarios_filtrados else None

def criar_conta(agencia: str, numero_conta: int, usuarios: list) -> dict | None:
...
def main() -> None:
    ...
    while True:
        ...
        if opcao == "d":
            ...
            # Atualizando para receber o numero_saques retornado pela função
